...
<body>
<h2 id = "txtHint"></h2>
<audio id ="1" src="/Assignment4/sounds/a.ogg"></audio>
<audio id ="2" src="/Assignment4/sounds/i.ogg"></audio>
<audio id ="3" src="/Assignment4/sounds/u.ogg"></audio>
<audio id ="4" src="/Assignment4/sounds/e.ogg"></audio>
<audio id ="5" src="/Assignment4/sounds/o.ogg"></audio>
<audio id ="6" src="/Assignment4/sounds/ka.ogg"></audio>
<audio id ="7" src="/Assignment4/sounds/ki.ogg"></audio>
<audio id ="8" src="/Assignment4/sounds/ku.ogg"></audio>
<audio id ="9" src="/Assignment4/sounds/ke.ogg"></audio>
<audio id ="10" src="/Assignment4/sounds/ko.ogg"></audio>
<audio id ="11" src="/Assignment4/sounds/sa.ogg"></audio>
<audio id ="12" src="/Assignment4/sounds/shi.ogg"></audio>
<audio id ="13" src="/Assignment4/sounds/su.ogg"></audio>
<audio id ="14" src="/Assignment4/sounds/se.ogg"></audio>
<audio id ="15" src="/Assignment4/sounds/so.ogg"></audio>
<audio id ="16" src="/Assignment4/sounds/ta.ogg"></audio>
<audio id ="17" src="/Assignment4/sounds/chi.ogg"></audio>
<audio id ="18" src="/Assignment4/sounds/tsu.ogg"></audio>
<audio id ="19" src="/Assignment4/sounds/te.ogg"></audio>
<audio id ="20" src="/Assignment4/sounds/to.ogg"></audio>
<audio id ="21" src="/Assignment4/sounds/na.ogg"></audio>
<audio id ="22" src="/Assignment4/sounds/ni.ogg"></audio>
<audio id ="23" src="/Assignment4/sounds/nu.ogg"></audio>
<audio id ="24" src="/Assignment4/sounds/ne.ogg"></audio>
<audio id ="25" src="/Assignment4/sounds/no.ogg"></audio>
<audio id ="26" src="/Assignment4/sounds/ha.ogg"></audio>
<audio id ="27" src="/Assignment4/sounds/hi.ogg"></audio>
<audio id ="28" src="/Assignment4/sounds/fu.ogg"></audio>
<audio id ="29" src="/Assignment4/sounds/he.ogg"></audio>
<audio id ="30" src="/Assignment4/sounds/ho.ogg"></audio>
<audio id ="31" src="/Assignment4/sounds/ma.ogg"></audio>
<audio id ="32" src="/Assignment4/sounds/mi.ogg"></audio>
<audio id ="33" src="/Assignment4/sounds/mu.ogg"></audio>
<audio id ="34" src="/Assignment4/sounds/me.ogg"></audio>
<audio id ="35" src="/Assignment4/sounds/mo.ogg"></audio>
<audio id ="36" src="/Assignment4/sounds/ya.ogg"></audio>
<audio id ="37" src="/Assignment4/sounds/yu.ogg"></audio>
<audio id ="38" src="/Assignment4/sounds/yo.ogg"></audio>
<audio id ="39" src="/Assignment4/sounds/ra.ogg"></audio>
<audio id ="40" src="/Assignment4/sounds/ri.ogg"></audio>
<audio id ="41" src="/Assignment4/sounds/ru.ogg"></audio>
<audio id ="42" src="/Assignment4/sounds/re.ogg"></audio>
<audio id ="43" src="/Assignment4/sounds/ro.ogg"></audio>
<audio id ="44" src="/Assignment4/sounds/wa.ogg"></audio>
<audio id ="45" src="/Assignment4/sounds/o.ogg"></audio>
<audio id ="46" src="/Assignment4/sounds/n.ogg"></audio>
...
<tr >
  ...
  <tr>
    ...
    <td class="tg-quxf"><img onmouseover="bigImg(this, 44)" onmouseout="normalImg(this, 44)" src="/Assignment4/static pictures/44.png" alt="Letter"  onclick = "document.getElementById('44').play()" style="width:90px;height:70px;"><div><button class = "button" onclick = "tick(this.parentElement), addToWorkset(this.parentElement.parentElement, 'wa')" >Add to Training Set</button><div><p></p></div></div></td>
    <td class="tg-quxf" style = background-color:#FFFFFF></td>
    <td class="tg-quxf" style = background-color:#FFFFFF></td>
    <td class="tg-quxf" style = background-color:#FFFFFF></td>
    <td class="tg-quxf"><img onmouseover="bigImg(this, 45)" onmouseout="normalImg(this, 45)" src="/Assignment4/static pictures/45.png" alt="Letter"  onclick = "document.getElementById('45').play()" style="width:90px;height:70px;"><div><button class = "button" onclick = "tick(this.parentElement), addToWorkset(this.parentElement.parentElement, 'o')" >Add to Training Set</button><div><p></p></div></div></td>
...
-->
		...
		<img id = "j" src='' alt='Letter' style='width:90px;height:70px;'>
		  ...
		  <br></br>
		  <button onclick = "validate(1)" class = "button">Submit Answers</button>
...
function bigImg(x, f) {
   x.src = "/Assignment4/gifs/"+f+".gif"
}

function normalImg(x, f) {

    x.src = "/Assignment4/static pictures/"+f+".png"
}
function sound(x, f){
	x.src = "/Assignment4/sounds/a.ogg"
	x.play()
}
function divPlay() {
